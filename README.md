...
This Newsletter sign-up form code component is designed to be easily integrated into your React projects, providing a visually appealing way to display socila-profiles design. The component is responsive and customizable, making it suitable for various projects.
## Table of contents
- [Overview](#overview)
...
### What I learned
Throughout the development of this project, I gained valuable insights into getting to use gradient colors in the design, responsive approach how to use full screen height and also building responsive and visually appealing user interfaces using React, Vite, and Tailwind CSS. Here are some key learnings highlighted with code samples:
...
- Integrated the 'Roboto', font from Google Fonts to enhance the typography of the project.
